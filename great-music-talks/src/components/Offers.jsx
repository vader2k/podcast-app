...
const Offers = () => {
  return (
    <div className='flex items-center justify-center sm:flex-row flex-col  sm:my-28 my-6 gap-5 py-10'>
      ...
      <h3 className='text-orange-600 text-[1rem] font-bold '>
              special offer to voice over
          </h3>
          <h2 className='font-semibold text-[2.5rem] py-5'>
              Best podcast for <br className='sm:hidden block'/>your curious mind
          </h2>
          <p className='font-semibold text-[1.5rem] text-gray-600'>
          ...
          <button type='button' className='bg-orange-600 mt-5 py-3 px-4 text-white text-[0.8rem] rounded-[30px]'>DISCOVER MORE</button>
      </div>
    </div>
  )
}
